...
impl AppConfig {
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            smart_money_fast_window_ms: env_parse("SMART_MONEY_FAST_WINDOW_MS", 800),
            smart_money_soft_window_ms: env_parse("SMART_MONEY_SOFT_WINDOW_MS", 2_200),
            gate3_hard_reject_ms: env_parse("GATE3_HARD_REJECT_MS", 2_500),
            ...
            gate3_fast_min_sol: env_parse("GATE3_FAST_MIN_SOL", 1.0),
            gate3_soft_min_sol: env_parse("GATE3_SOFT_MIN_SOL", 1.8),
            gate3_max_single_buyer_share: env_parse("GATE3_MAX_SINGLE_BUYER_SHARE", 0.70),
            ...
            gate3_early_concentration_min_buys: env_parse("GATE3_EARLY_CONCENTRATION_MIN_BUYS", 6),
