...
pub struct AppConfig {
    ...
    pub runtime_report_enabled: bool,
    pub runtime_report_interval_secs: u64,
    pub runtime_report_window_secs: u64,
    pub runtime_report_file: String,
    ...
    pub analytics_raw_event_retention_secs: u64,
    pub analytics_metrics_retention_secs: u64,
    pub analytics_execution_retention_secs: u64,
    ...
    pub sniper_single_buyer_filter_enabled: bool,
    pub sniper_single_buyer_min_sol: f64,
    pub sniper_single_buyer_min_buyer_quality_pct: f64,
    pub sniper_single_buyer_max_curve_progress_pct: f64,
    pub sniper_single_buyer_max_runtime_risk_penalty: u32,
    ...
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            coingecko_api_key: std::env::var("COINGECKO_API_KEY")
                .ok()
                .filter(|s| !s.trim().is_empty()),
            filter_db_path: env_or("FILTER_DB_PATH", "data/runtime.sqlite3"),
            analytics_db_path: env_or("ANALYTICS_DB_PATH", "data/analytics.sqlite3"),
            ...
            runtime_report_enabled: env_parse("RUNTIME_REPORT_ENABLED", true),
            runtime_report_interval_secs: env_parse("RUNTIME_REPORT_INTERVAL_SECS", 60),
            runtime_report_window_secs: env_parse("RUNTIME_REPORT_WINDOW_SECS", 300),
            runtime_report_file: env_or("RUNTIME_REPORT_FILE", "data/runtime_report.json"),
            ...
            persist_raw_scanner_events: env_parse("PERSIST_RAW_SCANNER_EVENTS", false),
            persist_gate3_sequences: env_parse("PERSIST_GATE3_SEQUENCES", false),
            persist_scoring_breakdowns: env_parse("PERSIST_SCORING_BREAKDOWNS", false),
            persist_label_suggestions: env_parse("PERSIST_LABEL_SUGGESTIONS", false),
            persist_feed_health: env_parse("PERSIST_FEED_HEALTH", false),
            analytics_raw_event_retention_secs: env_parse(
                "ANALYTICS_RAW_EVENT_RETENTION_SECS",
                3_600,
            ),
            analytics_metrics_retention_secs: env_parse("ANALYTICS_METRICS_RETENTION_SECS", 86_400),
            analytics_execution_retention_secs: env_parse(
                "ANALYTICS_EXECUTION_RETENTION_SECS",
                604_800,
            ),
            smart_money_window_secs: env_parse("SMART_MONEY_WINDOW_SECS", 60),
            smart_money_fast_window_ms: env_parse("SMART_MONEY_FAST_WINDOW_MS", 300),
            smart_money_soft_window_ms: env_parse("SMART_MONEY_SOFT_WINDOW_MS", 800),
            gate3_hard_reject_ms: env_parse("GATE3_HARD_REJECT_MS", 1_000),
            smart_money_fast_threshold: env_parse("SMART_MONEY_FAST_THRESHOLD", 0),
            smart_money_threshold: env_parse("SMART_MONEY_THRESHOLD", 0),
            smart_money_max_buys: env_parse("SMART_MONEY_MAX_BUYS", 20),
            gate3_fast_min_sol: env_parse("GATE3_FAST_MIN_SOL", 0.20),
            gate3_soft_min_sol: env_parse("GATE3_SOFT_MIN_SOL", 0.70),
            gate3_max_single_buyer_share: env_parse("GATE3_MAX_SINGLE_BUYER_SHARE", 0.55),
            ...
            sniper_single_buyer_filter_enabled: env_parse(
            ...
            sniper_single_buyer_max_runtime_risk_penalty: env_parse(
                "SNIPER_SINGLE_BUYER_MAX_RUNTIME_RISK_PENALTY",
                4,
            ),
            ...
            creator_gate_sniper_fast_timeout_ms: env_parse(
