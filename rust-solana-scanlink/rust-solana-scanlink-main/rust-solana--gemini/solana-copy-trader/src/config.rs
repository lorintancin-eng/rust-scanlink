...
impl AppConfig {
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            gate3_creator_self_buy_max_sol: env_parse("GATE3_CREATOR_SELF_BUY_MAX_SOL", 0.20),
            gate3_creator_self_buy_max_share: env_parse("GATE3_CREATOR_SELF_BUY_MAX_SHARE", 0.25),
            gate3_creator_self_buy_hard_sol: env_parse("GATE3_CREATOR_SELF_BUY_HARD_SOL", 2.00),
