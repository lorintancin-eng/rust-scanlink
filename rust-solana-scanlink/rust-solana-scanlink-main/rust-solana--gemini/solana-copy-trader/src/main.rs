...
async fn main() -> Result<()> {
    ...
    info!(
        "Gate3 windows: fast={}ms soft={}ms hard={}ms | thresholds: buyers_fast={} buyers_soft={} sol_fast={:.2} sol_soft={:.2} max_share={:.2} self_buy_max_sol={:.2} self_buy_max_share={:.2} | smart_money_disabled={} | helius={} | creator_gate_timeout_ms={} | hotlists: wallets={} funders={} blocked={}",
